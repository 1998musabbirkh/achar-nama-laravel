    ...
    <div class="flex flex-col gap-4 md:flex-row justify-between items-center">
        ...
        <div class="flex flex-col order-2 gap-4 md:order-1 md:w-[52%]">
            ...
            <div class="flex gap-4 justify-center md:justify-start order-1 md:order-none">
                ...
                <a href="tel:+8801401383238" class="px-5 text-center py-2 border border-brand-green text-brand-green hover:bg-brand-green hover:text-white transition-colors duration-300 font-bengali text-sm md:text-base rounded-sm flex-1 md:flex-none">আমাদের কল করুন</a>
            </div>
